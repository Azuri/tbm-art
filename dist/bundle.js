    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        { onSubmit: function onSubmit(e) {
            e.preventDefault();
            _this2.props.onSubmit(input.value);
            input.value = '';
            input.focus();
          } },
        _react2.default.createElement('input', { type: 'text', autoFocus: true, ref: function ref(node) {
            input = node;
          } }),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    onSubmit: function onSubmit(text) {
      ...
      dispatch((0, _actions.add)(text));
    }
  };
};

var Form = (0, _reactRedux.connect)(null, mapDispatchToProps)(AddTodo);
  ...
  _createClass(List, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'ul',
        null,
        this.props.todos.toArray().map(function (todo, index) {
          return _react2.default.createElement(_Todo2.default, _extends({ key: index }, todo, { onClick: function onClick() {
              ...
              _this2.props.onRemoveClick(index);
            } }));
        })
      );
    }
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    onTodoClick: function onTodoClick(index) {
      dispatch((0, _index.toggle)(index));
    },
    onRemoveClick: function onRemoveClick(index) {
      dispatch((0, _index.remove)(index));
    }
  };
};
...
var store = (0, _redux.createStore)(_index.app);
...
function todos() {
  ...
  switch (action.type) {
    case _types.ADD_TODO:
      ...
      break;
    case _types.REMOVE_TODO:
      newState = state.delete(action.index);
      break;
    case _types.TOGGLE_TODO:
      newState = state.update(action.index, function (todo) {
